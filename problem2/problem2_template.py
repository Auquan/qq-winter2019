...
class MyTradingFunctions():
    ...
    def getWeights(self, identifiers, reward, wi, Dt, St, Qt, g, U, t, T, P, delta, chi, eta, df, trr, wt_1,**kwargs):
        ################################################
        ...
        div_constraint = np.maximum(g, 1/float(len(wi)))
    ...
    def getPrediction(self,identifiers, wi, Dt, St, Qt, g, U, t, T, P, delta, chi, eta, df, trr, wt_1,**kwargs):
